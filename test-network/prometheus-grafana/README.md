...
5. Deploy a chaincode (i.e. "./network.sh deployCC -ccn basic -ccp ../agro-supply-chain/chaincode-go -ccl go"), start using the test-network and use the Grafana dashboard to analyse and assess your network performances.
