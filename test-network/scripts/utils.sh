...
function printHelp() {
  ...
  if [ "$USAGE" == "prereq" ]; then
    ...
    println
    println " Examples:"
    println "   network.sh deployCC -ccn basic -ccp ../agro-supply-chain/chaincode-javascript/ ./ -ccl javascript"
    ...
    println
    println " Examples:"
    println "   network.sh deployCCAAS  -ccn basicj -ccp ../agro-supply-chain/chaincode-java"
    println "   network.sh deployCCAAS  -ccn basict -ccp ../agro-supply-chain/chaincode-typescript -ccaasdocker false" 
  elif [ "$USAGE" == "cc" ] ; then
    println "Usage: "
    ...
    println "   network.sh cc package -ccn basic -ccp chaincode/agro-supply-chain/go -ccv 1.0.0 -ccl go"
    ...
    println "      \033[0;32mdeployCC\033[0m - Deploy a chaincode to a channel (defaults to agro-supply-chain)"
